 ...
 * Class Nav Menu.
 */
class Pixelaxis_Navigation_Menu extends Widget_Base {
	/**
	 * Menu index.
	 *
	 * @access protected
		...
		$this->start_controls_tabs( 'tabs_menu_item_style' );
			...
			$this->add_control(
				...
				[
					...
					'default'   => '',
					'selectors' => [
						'#pixelaxis-header .tp-sticky' => 'background: {{VALUE}} !important',
						'#pixelaxis-header .tp-sticky .bg-remove' => 'background: {{VALUE}} !important',
					],
				]
			);	
			...
			$this->add_group_control(
				...
				[
					...
					'selector'  => '#pixelaxis-header .tp-sticky',
					'separator' => 'after',
				]
			);
