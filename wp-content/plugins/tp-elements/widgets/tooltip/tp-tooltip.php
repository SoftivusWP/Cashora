...
class Pixelaxis_Elementor_Pro_Tooltip_Box_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'TP Tooltip', 'tp-elements' );
	}
	 ...
	 */
		...
		$this->start_controls_section(
			'section_services',
			[
				'label' => esc_html__( 'Tooltip Global Option', 'tp-elements' ),
		...
		$this->add_control(
			'tooltip_title',
			[
				'label'       => esc_html__( 'Tooltip Title', 'tp-elements' ),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'default'     => 'TP Tooltip',
				'placeholder' => esc_html__( 'TP Tooltip', 'tp-elements' ),
				'separator'   => 'before',
			]
		);
		...
		$this->add_control(
			'tooltip_image',
			[
				'label' => esc_html__( 'Choose Tooltip Image', 'tp-elements' ),
		...
		$this->add_control(
			'rs_tooltip_position',
			[
				'label'   => esc_html__( 'Tooltip Position', 'tp-elements' ),
		...
		$this->add_control(
			'text',
			[
				'label' => esc_html__( 'Box Description', 'tp-elements' ),
		...
		$this->add_responsive_control(
		    'icon_size',
		    [
		        'label' => esc_html__( 'Icon Area Size', 'tp-elements' ),
