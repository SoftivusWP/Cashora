	 ...
	 */
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'example 7', 'tp-elements' ),
				'separator' => 'before',
			]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tp-coupons-navigation' => 'margin-top: {{SIZE}}{{UNIT}};',                    
                ],
                'condition' => [ 
                    'slider_navigation' => 'true', 
                    'slider_nav_position' => 'false', 
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .tp-coupons-navigation > div' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [ 
                    'slider_navigation' => 'true', 
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .tp-coupons-navigation > div' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                ],
                'condition' => [ 'slider_navigation' => 'true', ],
            ]
        );
        ...
        $this->add_group_control(
		    ...
		    [
		        ...
		        'selector' => '{{WRAPPER}} .tp-coupons-navigation > div',
                'condition' => [ 'slider_navigation' => 'true', ],
		    ]
		);
        $this->add_group_control(
		    ...
		    [
		        ...
		        'selector' => '{{WRAPPER}} .tp-coupons-navigation > div:hover',
                'condition' => [ 'slider_navigation' => 'true', ],
		    ]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tp-coupons-navigation > div' => 'background-color: {{VALUE}} !important;',
                ],
                'condition' => [ 'slider_navigation' => 'true', ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tp-coupons-navigation > div:hover' => 'background-color: {{VALUE}} !important;',
                ],
                'condition' => [ 'slider_navigation' => 'true', ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tp-coupons-navigation > div i' => 'color: {{VALUE}} !important;',
                ],
                'condition' => [ 'slider_navigation' => 'true', ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tp-coupons-navigation > div:hover i' => 'color: {{VALUE}} !important;',
                ],
                'condition' => [ 'slider_navigation' => 'true', ],
            ]
        );
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => ['px'],
		        'selectors' => [
		            '{{WRAPPER}} .themephi-addon-coupons .tp-coupon-count' => 'margin: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => ['px'],
		        'selectors' => [
		            '{{WRAPPER}} .themephi-addon-coupons .tp-coupon-count' => 'padding: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
	...
	protected function render() {
		...
		$sstyle = $settings['coupon_style'];
			...
			<style>
				...
				/* Slider Navigation  */
				.tp-coupons-wrapper.true .tp-coupons-navigation > div {
					position: absolute;
					top: 50%;
				...
				.tp-coupons-wrapper.true .tp-coupons-navigation .tp-coupons-slide-next {
					left: auto;
					right: 0px;
				}
			...
			<div class="tp-coupons-wrapper <?php echo esc_attr( $settings['slider_nav_position'] ); ?> coupons-wrapper-<?php echo esc_attr( $settings['coupon_style'] ); ?> position-relative ">
                <?php if( $settings['coupon_grid_source'] == 'dynamic' ) : ?>
                    ...
                    <div class="row row-cols-<?php echo esc_attr( $settings['even_col_xs'] ); ?> row-cols-sm-<?php echo esc_attr( $settings['even_col_sm'] ); ?> row-cols-md-<?php echo esc_attr( $settings['even_col_md'] ); ?> row-cols-lg-<?php echo esc_attr( $settings['even_col_lg'] ); ?> row-cols-xl-<?php echo esc_attr( $settings['even_col_xl'] ); ?> row-cols-xxl-<?php echo esc_attr( $settings['even_col_xxl'] ); ?>  <?php if ( $settings['enable_item_gutter'] == 'yes' ) : ?>  g-0 <?php endif; ?>" <?php if ( $settings['enable_item_massonry'] == 'yes' ) : ?>  data-masonry='{ "percentPosition": false }' <?php endif; ?> >
                ...
                <?php endif; ?>
                    ...
                    $categories_per_page = !empty($settings['per_page']) ? intval($settings['per_page']) : 7;
				...
				<div class="tp-coupons-navigation d-flex">
					<div class="tp-coupons-slide-prev "><i class="tp tp-arrow-left"></i></div>
					<div class="tp-coupons-slide-next "><i class="tp tp-arrow-right"></i></div>
				</div>
				<?php endif; endif; ?>
