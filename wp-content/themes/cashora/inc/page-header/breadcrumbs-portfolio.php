...
if ($post_meta_data == '') {
    if (!empty($cashora_option['portfolio_banner_main']['url'])):
        $post_meta_data = $cashora_option['portfolio_banner_main']['url'];
    elseif (!empty($cashora_option['page_banner_main']['url'])):
        $post_meta_data = $cashora_option['page_banner_main']['url'];

    else: {
            $portfolio_banner_bg_color = !empty($cashora_option['portfolio_banner_bg_color']) ? $cashora_option['portfolio_banner_bg_color'] : '';
...
$portfolio_title = $cashora_option['portfolio_title'] ?? '';
?>
