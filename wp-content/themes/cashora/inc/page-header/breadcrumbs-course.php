...
if ($post_meta_data == '') {
    if (!empty($cashora_option['course_banner']['url'])):
        $post_meta_data = $cashora_option['course_banner']['url'];
    endif;
}
...
if (!empty($cashora_option['show_banner__course'])):
    $post_meta_data = $cashora_option['show_banner__course'];
endif;
?>
...
<div class="pixelaxis-breadcrumbs">
    ...
    <?php } elseif (!empty($cashora_option['course_banner']['url'])) {
        $course_banner = $cashora_option['course_banner']['url']; ?>
