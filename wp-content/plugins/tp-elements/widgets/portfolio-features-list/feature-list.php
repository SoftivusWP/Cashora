...
class Pixelaxis_Portfolio_Features_List_Widget extends \Elementor\Widget_Base {


    public function get_name() {
        return 'tp-portfolio-featureslist';
    }
    ...
    public function get_title() {
        return esc_html__( 'TP Portfolio Features', 'tp-elements' );
    }
	...
	protected function register_controls() {
        ...
        'heading_title',
        [
            'label' => esc_html__( 'Project Information Heading', 'tp-elements' ),
    ...
    $repeater->add_control(
        'information_title',
        [
            'label' => esc_html__('Information Title', 'tp-elements'),
            'type' => Controls_Manager::TEXT,
            'default' => esc_html__('Project Information', 'tp-elements'),
            'label_block' => true,
    ...
    $repeater->add_control(
        'information_value',
        [
            'label' => esc_html__('Information Value', 'tp-elements'),
	...
	protected function render() {
        ...
        <div class="tp-features-list-portfolio-content">
