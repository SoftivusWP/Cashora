<div class="col " >
    ...
    <div class="themephi-addon-coupons position-relative <?php echo esc_attr( $settings['image_or_icon_vertical_align'] ); ?> <?php echo esc_attr( $settings['image_or_icon_position'] ); ?> coupons-<?php echo esc_attr( $settings['coupon_style'] ); ?> coupons-<?php echo esc_attr( $settings['coupon_grid_source'] ); ?>">
        ...
        <div class="tp-coupon-item" >
            ...
            <div class="tp-coupon-item-img <?php echo esc_attr( $settings['alignment_image'] ); ?>">
                <img src="<?php echo esc_url( $category_image_url ); ?>" alt="category image">
            </div>
            <?php }?>
            ...
            <div class="tp-coupon-item-content-wrapper <?php echo esc_attr( $settings['button_position'] ); ?>">
                ...
                <div class="tp-coupon-content-wrapp">
                    ...
                    <<?php echo esc_attr( $settings['title_tag'] ); ?> class="tp-coupon-title"><a href="<?php echo esc_url( $category_link ); ?>"><?php echo wp_trim_words( $category_name, $title_limit, '...' ); ?></a></<?php echo esc_attr( $settings['title_tag'] ); ?>>
                    <?php endif; ?>
                    
                    <?php if( $settings['coupon_text_show_hide'] == 'yes' ) : ?>
                    <div class="tp-coupon-desc">
                    <?php echo wp_kses_post( wp_trim_words( $category_description, $text_limit, '...' ) ); ?>
                    </div>
                    <?php endif; ?>
                ...
                <div class="tp-coupon-button-wrapp <?php echo esc_attr( $settings['button_vertical_align'] ); ?>">
                    ...
                    <div class="tp-coupon-button">
                        ...
                        ?>
                        <a class="tp-cat-button <?php echo esc_attr( $icon_position ); ?>" href="<?php echo esc_url( $category_link ); ?>" rel="nofollow" <?php echo wp_kses_post($link_open); ?> >
                            ...
                            <span class="tp-cat-btn-text"><?php echo esc_html( $settings['coupon_btn_text'] ); ?></span>
                            <?php endif; ?>
            ...
            <?php if( $settings['coupon_count_show_hide'] == 'yes' ) : ?>
                <span class="tp-coupon-count"><?php echo esc_html( $category_post_count ); ?></span>
            <?php endif; ?>
