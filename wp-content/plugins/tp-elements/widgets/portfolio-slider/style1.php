            ...
            <div class="portfolio-content">
                <div class="vertical-middle">
                    <div class="vertical-middle-cell">
                    	...
                    	<?php endif;?>	
                    	<div class="portfolio-text"><?php echo wp_trim_words( get_the_excerpt(), 10 );?></div>
                    </div>
                </div>
            </div>
            <a class="read-btn link-button" href="<?php the_permalink();?>"><?php echo esc_html(  $details_btn_text  );?> <span class="f-right"><i class="tp-arrow-right-long"></i></span></a>
        </div>
