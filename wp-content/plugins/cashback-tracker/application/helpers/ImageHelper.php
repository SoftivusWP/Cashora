...
class ImageHelper
{
    ...
    public static function saveImgLocaly($img_uri, $title = '', $check_image_type = true, $return_full_path = false)
    {
        ...
        if ($newfilename = self::downloadImg($img_uri, $uploads['path'], $newfilename, null, $check_image_type, $return_full_path))
            return $newfilename;
        else
            return false;
    }

    public static function downloadImg($img_uri, $save_dir, $file_name, $file_ext = null, $check_image_type = true, $return_full_path = false)
    {
