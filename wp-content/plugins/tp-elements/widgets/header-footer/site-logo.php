 ...
 * @since 1.3.0
 */
class Pixelaxis_Site_Logo extends Widget_Base {
	...
	public function get_title() {
		return __( 'TP Site Logo', 'tp-elements' );
	}
	...
	protected function register_content_site_logo_controls() {
		$this->start_controls_section(
			'section_site_image',
			[
				'label' => __( 'Site Logo', 'tp-elements' ),
			]
		);
		...
		$this->add_control(
			'site_logo_fallback',
			[
				'label'       => __( 'Custom Image', 'tp-elements' ),
				'type'        => Controls_Manager::SWITCHER,
				'yes'         => __( 'Yes', 'tp-elements' ),
				'no'          => __( 'No', 'tp-elements' ),
				'default'     => 'no',
		...
		$this->add_control(
			'custom_image',
			[
				'label'     => __( 'Add Image', 'tp-elements' ),
		...
		$this->add_control(
			'caption',
			[
				'label'       => __( 'Custom Caption', 'tp-elements' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => '',
				'placeholder' => __( 'Enter caption', 'tp-elements' ),
				'condition'   => [
					'caption_source' => 'yes',
				],
				'dynamic'     => [
		...
		$this->add_control(
			...
			[
				...
				'default' => 'default',
				'options' => [
					'default' => __( 'Default', 'tp-elements' ),
					'none'    => __( 'None', 'tp-elements' ),
					'file'    => __( 'Media File', 'tp-elements' ),
					'custom'  => __( 'Custom URL', 'tp-elements' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'https://your-link.com', 'tp-elements' ),
				'condition'   => [
					'link_to' => 'custom',
				],
				'show_label'  => false,
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Sticky Logo', 'tp-elements' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'       => __( 'Sticky Image', 'tp-elements' ),
				'type'        => Controls_Manager::SWITCHER,
				'yes'         => __( 'Yes', 'tp-elements' ),
				'no'          => __( 'No', 'tp-elements' ),
				'default'     => 'no',
	...
	protected function register_site_logo_styling_controls() {
		...
		$this->add_responsive_control(
			'width',
			[
				'label'              => __( 'Logo Width', 'tp-elements' ),
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Transition Duration', 'tp-elements' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'max'  => 3,
