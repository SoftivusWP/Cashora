...
<?php
$enable_breadcrumb_title = $cashora_option['enable_breadcrumb_title'] ?? '';

$post_meta_data = get_post_meta(get_the_ID(), 'banner_image', true);
$post_meta_data2 = '';
//theme option chekcing
if ($post_meta_data == '') {
  if (!empty($cashora_option['blog_banner_single']['url'])):
    $post_meta_data = $cashora_option['blog_banner_single']['url'];
  elseif (!empty($cashora_option['blog_banner_main']['url'])):
    $post_meta_data = $cashora_option['blog_banner_main']['url'];
  elseif (!empty($cashora_option['page_banner_main']['url'])):
    $post_meta_data = $cashora_option['page_banner_main']['url'];

  else: {
      $post_meta_data2 = !empty($cashora_option['breadcrumb_bg_color']) ? $cashora_option['breadcrumb_bg_color'] : '';
    }
  endif;
}
...
<?php if ($post_meta_data != '') {
  $blog_banner_bg_color = !empty($cashora_option['blog_banner_bg_color']) ? $cashora_option['blog_banner_bg_color'] : '';
  $breadcrumb_bg_color = !empty($cashora_option['breadcrumb_bg_color']) ? $cashora_option['breadcrumb_bg_color'] : '';

  $post_meta_data2 = !empty($blog_banner_bg_color) ? $blog_banner_bg_color : $breadcrumb_bg_color;
?>
