...
class Pixelaxis_Contactbox_List_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'TP Iconbox List', 'tp-elements' );
    }
	...
	protected function register_controls() {
        ...
        $repeater->add_control(
            'sub-text',
            [
                'label' => esc_html__( 'Sub Title Title', 'tp-elements' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [   
                        'text' => esc_html__( '890.234.112', 'tp-elements' ),
                        'icon' => 'fas fa-phone',
                    ],
                    [
                        'text' => esc_html__( 'info@webmail.com', 'tp-elements' ),
       ...
       $this->add_responsive_control(
        ...
        $this->add_control(
            'sub_text_color',
            [
                'label' => esc_html__( 'Sub Text Color', 'tp-elements' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'sub_text_hover_color',
            [
                'label' => esc_html__( 'Sub Text Hover Color', 'tp-elements' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .sub-text:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .text-heading' => 'color: {{VALUE}};',
                ],
            ]
        ); 
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .text-heading:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
