...
class Pixelaxis_Elementor_thumbnail_slider_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'TP Post Thumbnail Slider', 'tp-elements' );
	}
