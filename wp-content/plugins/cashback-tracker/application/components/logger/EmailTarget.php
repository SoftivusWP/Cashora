...
namespace CashbackTracker\application\components\logger;

defined('\ABSPATH') || exit;

use CashbackTracker\application\Plugin;
use CashbackTracker\application\helpers\EmailHelper;
...
class EmailTarget extends Target
{
    ...
    public function export()
    {
        ...
        $subject = Plugin::getName() . ' ' . __('alerts', 'cashback-tracker') . ' - ' . $domain;
