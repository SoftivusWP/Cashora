...
class Pixelaxis_Pro_Dual_Button_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'TP Dual Button', 'tp-elements' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            '_section_button',
            [
                'label' => esc_html__( 'Dual Buttons', 'tp-elements' ),
        ...
        $this->start_controls_tab(
            '_tab_button_primary',
            [
                'label' => esc_html__( 'Primary', 'tp-elements' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => 'https://pixelaxis.net/',
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => esc_html__( 'Connector', 'tp-elements' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Hide Connector?', 'tp-elements' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Hide', 'tp-elements' ),
                'label_off' => esc_html__( 'Show', 'tp-elements' ),
                'style_transfer' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Connector Type', 'tp-elements' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'text' => [
                        'title' => esc_html__( 'Text', 'tp-elements' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Text', 'tp-elements' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Or', 'tp-elements' ),
                'condition' => [
                    'button_connector_hide!' => 'yes',
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => esc_html__( 'Secondary', 'tp-elements' ),
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Common', 'tp-elements' ),
        ...
        $this->add_responsive_control(
            'button_gap',
            [
                'label' => esc_html__( 'Space Between Buttons', 'tp-elements' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'selectors' => [                    
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Primary Button', 'tp-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'raw' => esc_html__( 'Connector is hidden now, please enable connector from Content > Connector tab.', 'tp-elements' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Secondary Button', 'tp-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
