...
class Pixelaxis_Elementor_CF7_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'TP Contact Form 7', 'tp-elements' );
    }
	...
	protected function register_controls() {
		$this->start_controls_section(
			'_section_cf7',
			[
				'label' => class_exists( 'WPCF7' ) ? esc_html__( 'Contact Form 7', 'tp-elements' ) : esc_html__( 'Notice', 'tp-elements' ),
        ...
        if ( ! class_exists( 'WPCF7' ) ) {
            $this->add_control(
                ...
                [
                    ...
                    'raw' => sprintf(
                        esc_html__( 'Hi, it seems contact form7 is missing in your site. Please install and activate contact form7 first.', 'tp-elements' ),
        ...
        $this->add_control(
            'selected_form_id',
            [
                'label' => esc_html__( 'Chosse Your Form', 'tp-elements' ),
                'type' => Controls_Manager::SELECT,
                'label_block' => true,
                'options' => ['' => esc_html__( '', 'tp-elements' ) ] + \tp_get_cf7_forms(),
            ]
        );      
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Form Fields', 'tp-elements' ),
        ...
        $this->add_responsive_control(
            'field_margin',
            [
                'label' => esc_html__( 'Spacing Bottom', 'tp-elements' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
        ...
        $this->start_controls_section(
            'cf7-form-label',
            [
                'label' => esc_html__( 'Form Fields Label', 'tp-elements' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
    ...
    protected function render() {
        ...
        if ( ! empty( $settings['selected_form_id'] ) ) {
            echo '<div class="form__btn__'.$settings['btn_item_alignment'].'">';
