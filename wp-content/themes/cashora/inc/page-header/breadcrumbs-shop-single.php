...
if ($post_meta_data == '') {
    if (!empty($cashora_option['shop_banner_single']['url'])):
        $post_meta_data = $cashora_option['shop_banner_single']['url'];
    elseif (!empty($cashora_option['shop_banner_main']['url'])):
        $post_meta_data = $cashora_option['shop_banner_main']['url'];
...
<?php if ($post_meta_data != '') {
    $shop_banner_bg_color = !empty($cashora_option['shop_banner_bg_color']) ? $cashora_option['shop_banner_bg_color'] : '';
